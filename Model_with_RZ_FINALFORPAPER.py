...
UPDATED: Incorporates red zone data for better TD predictions.
"""
...
class WRProjectionModel:
    ...
    def load_data(self):
        ...
        # First, try to load the comprehensive dataset with red zone data
        ...
        if comprehensive_file.exists():
            ...
            # Try alternate filename in case it's in the current directory
        ...
        # If we have comprehensive data, check what's missing and supplement
        if not comprehensive_df.empty:
            ...
            # This dataset has red zone data but might be missing basic receiving stats
            # We need to merge with the main receiving data
            ...
            if receiving_file.exists():
                ...
                # Merge receiving stats with red zone data
                # Start with receiving data as base (more complete)
                ...
                # Clean up duplicate team columns if any
                if 'Tm_rz' in df.columns:
                    # Use red zone team data where available, otherwise keep original
                ...
                # If no basic receiving data, use comprehensive as base
        ...
        # Load additional datasets regardless
    ...
    def engineer_base_features(self, df):
        ...
        # Red zone efficiency metrics (key for TD prediction)
        ...
        # Red zone opportunity share (RZ targets as % of total targets)
        if 'RZ_Targets' in df.columns and 'Tgt' in df.columns:
            df['RZ_Target_Share'] = df['RZ_Targets'] / df['Tgt'].clip(lower=1)
        
        # Red zone efficiency proxy (longer plays more likely to be TDs)
...
• Includes red zone data
    ...
    def run_full_analysis(self):
        ...
        print(f"✅ Red zone data integrated for better TD predictions")
